...
static const token_info_t TOKEN_MAPPING[] = {
    {
        ...
        .coin_type = "0x111ae3e5bc816a5e63c2da97d0aa3886519e0cd5e4b046659fa35796bd11542a::amapt_token::AmnisApt"
    },
    {
        .ticker = "APARTMENT",
        .token = "Apartment",
        .coin_type = "0x7b7bab2131de3e4f318b4abaa952f7c817b2c3df16c951caca809ac9ca9b650e::APARTMENT::APARTMENT"
    },
    {
        .ticker = "APE",
        .token = "APETOS",
        .coin_type = "0xada35ada7e43e2ee1c39633ffccec38b76ce702b4efc2e60b50f63fbe4f710d8::apetos_token::ApetosCoin"
    },
    {
        .ticker = "APT",
        .token = "Aptos Coin",
    ...
    },
    {
        .ticker = "FOMO",
        .token = "APTOS FOMO",
        .coin_type = "0xf891d2e004973430cc2bbbee69f3d0f4adb9c7ae03137b4579f7bb9979283ee6::APTOS_FOMO::APTOS_FOMO"
    },
    {
        .ticker = "ALT",
        .token = "Aptos Launch Token",
        .coin_type = "0xd0b4efb4be7c3508d9a26a9b5405cf9f860d0b9e5fe2f498b90e68b8d2cedd3e::aptos_launch_token::"
                     "AptosLaunchToken"
    },
    {
        .ticker = "BLT",
    ...
    },
    {
        .ticker = "MOVE",
        .token = "BlueMove",
        .coin_type = "0x27fafcc4e39daac97556af8a803dbb52bcb03f0821898dc845ac54225b9793eb::move_coin::MoveCoin"
    },
    {
        .ticker = "BUBBLES",
        .token = "BUBBLES",
        .coin_type = "0xd6a49762f6e4f7401ee79be6f5d4111e70db1408966ba1aa204e6e10c9d437ca::bubbles::BubblesCoin"
    },
    {
        .ticker = "doodoo",
        .token = "DooDoo",
        .coin_type = "0x73eb84966be67e4697fc5ae75173ca6c35089e802650f75422ab49a8729704ec::coin::DooDoo"
    },
    {
        .ticker = "dstAPT",
        .token = "dstAPT",
        .coin_type = "0xd11107bdf0d6d7040c6c0bfbdecb6545191fdf13e8d8d259952f53e1713f61b5::staked_coin::StakedAptos"
    },
    {
        .ticker = "whGARI",
        .token = "Gari (Wormhole)",
    ...
    },
    {
        .ticker = "GUI",
        .token = "Gui Inu",
        .coin_type = "0xe4ccb6d39136469f376242c31b34d10515c8eaaa38092f804db8e08a8f53c5b2::assets_v1::EchoCoin002"
    },
    {
        .ticker = "HEART",
        .token = "HEART",
        .coin_type = "0x7de3fea83cd5ca0e1def27c3f3803af619882db51f34abf30dd04ad12ee6af31::tapos::Heart"
    },
    {
        .ticker = "LSD",
        .token = "Liquidswap",
    ...
    },
    {
        .ticker = "MOOMOO",
        .token = "MOO MOO",
        .coin_type = "0xc5fbbcc4637aeebb4e732767abee8a21f2b0776f73b73e16ce13e7d31d6700da::MOOMOO::MOOMOO"
    },
    {
        .ticker = "MOD",
        .token = "Move Dollar",
        .coin_type = "0x6f986d146e4a90b828d8c12c14b6f4e003fdff11a8eecceceb63744363eaac01::mod_coin::MOD"
    },
    {
        .ticker = "Cake",
        .token = "PancakeSwap Token",
        .coin_type = "0x159df6b7689437016108a019fd5bef736bac692b6d4a1f10c941f6fbb9a74ca6::oft::CakeOFT"
    },
    {
        .ticker = "RETuRD",
        .token = "Returd",
        .coin_type = "0xdf3d5eb83df80dfde8ceb1edaa24d8dbc46da6a89ae134a858338e1b86a29e38::coin::Returd"
    },
    {
        .ticker = "SHRIMP",
        .token = "SHRIMP",
        .coin_type = "0x55987edfab9a57f69bac759674f139ae473b5e09a9283848c1f87faf6fc1e789::shrimp::ShrimpCoin"
    },
    {
        .ticker = "whSOL",
    ...
    },
    {
        ...
        .coin_type = "0x111ae3e5bc816a5e63c2da97d0aa3886519e0cd5e4b046659fa35796bd11542a::stapt_token::StakedApt"
    },
    {
        .ticker = "sthAPT",
        .token = "Staked Thala APT",
        .coin_type = "0xfaf4e633ae9eb31366c9ca24214231760926576c7b625313b3688b5e900731f6::staking::StakedThalaAPT"
    },
    {
        .ticker = "ceUSDT",
        .token = "Tether USD (Celer)",
        .coin_type = "0x8d87a65ba30e09357fa2edea2c80dbac296e5dec2b18287113500b902942929d::celer_coin_manager::UsdtCoin"
    },
    {
        .ticker = "lzUSDT",
    ...
    },
    {
        .ticker = "thAPT",
        .token = "Thala APT",
        .coin_type = "0xfaf4e633ae9eb31366c9ca24214231760926576c7b625313b3688b5e900731f6::staking::ThalaAPT"
    },
    {
        .ticker = "THL",
        .token = "Thala Token",
    ...
    },
    {
        .ticker = "TIN",
        .token = "Token \"IN\"",
        .coin_type = "0xc32ba5d293577cbb1df390f35b2bc6369a593b736d0865fedec1a2b08565de8e::in_coin::InCoin"
    },
    {
        .ticker = "TOMA",
        .token = "Tomarket",
        .coin_type = "0x9d0595765a31f8d56e1d2aafc4d6c76f283c67a074ef8812d8c31bd8252ac2c3::asset::TOMA"
    },
    {
        .ticker = "tAPT",
        .token = "Tortuga Staked APT",
        .coin_type = "0x84d7aeef42d38a5ffc3ccef853e1b82e4958659d16a7de736a29c55fbbeb0114::staked_aptos_coin::"
                     "StakedAptosCoin"
    },
    {
        .ticker = "UPTOS",
        .token = "UPTOS",
        .coin_type = "0x4fbed3f8a3fd8a11081c8b6392152a8b0cb14d70d0414586f0c9b858fcd2d6a7::UPTOS::UPTOS"
    },
    {
        .ticker = "lzUSDC",
    ...
    },
    {
        ...
        .coin_type = "0x8d87a65ba30e09357fa2edea2c80dbac296e5dec2b18287113500b902942929d::celer_coin_manager::BnbCoin"
    },
    {
        .ticker = "lzWETH",
...
int ui_prepare_tx_coin_transfer() {
    ...
    // can have an arbitary number of leading zeros
    if (memcmp(transfer->ty_coin.name.bytes, "AptosCoin", transfer->ty_coin.name.len) == 0 &&
        memcmp(transfer->ty_coin.module_name.bytes, "aptos_coin", transfer->ty_coin.module_name.len) == 0) {
